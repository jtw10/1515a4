...
for i in range(0, len(element_list)):
    ...
    # number of loops
        ...
        for j in range(0, element_list[i]):
            x = random.randint(0, element_list[i])
            numbers.append(x)
    ...
    print(' ' + str(element_list[i]), 'Element(s) To Be Sorted', '--', 'Average of', count, 'sortings.')
    print(' insertion sort average:  ', insertion_avg, 'seconds', sum(insertion_time))
